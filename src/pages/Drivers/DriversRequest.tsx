...
import { useGetRequestDriversQuery } from "@/redux/features/driver/driverApi";
import { formatDate } from "@/utils/dateFormet";
import { useState } from "react";
import { IoEyeOutline } from "react-icons/io5";
import { AllImages } from "../../../public/images/AllImages";

const DriversRequestPage = () => {
    ...
    const { data, isFetching } = useGetRequestDriversQuery(
    ...
    const columns: Column<IDriver>[] = [
        ...
        },
        {
            ...
            render: (value: string) => (
                <Tag
                    theme={value === "verified" ? "success" : value === "rejected" ? "error" : "warning"}
    ...
    return (
        <PageWraper title="Driver Requests">
...
export default DriversRequestPage;
